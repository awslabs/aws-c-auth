...
AWS_STATIC_STRING_FROM_LITERAL(s_ecc_derive_suite_access_key_id_test_value, "AKISORANDOMAASORANDOM");
AWS_STATIC_STRING_FROM_LITERAL(
    s_ecc_derive_suite_secret_access_key_test_value,
    "q+jcrXGc+0zWN6uzclKVhvMmUsIfRPa4rlRandom");
 ...
 */
AWS_STATIC_STRING_FROM_LITERAL(
    s_expected_suite_pub_x,
    "15d242ceebf8d8169fd6a8b5a746c41140414c3b07579038da06af89190fffcb");
AWS_STATIC_STRING_FROM_LITERAL(
    s_expected_suite_pub_y,
    "0515242cedd82e94799482e4c0514b505afccf2c0c98d6a553bf539f424c5ec0");

static int s_credentials_derive_ecc_key_suite(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;

    struct aws_credentials *creds = aws_credentials_new_from_string(
        allocator,
        s_ecc_derive_suite_access_key_id_test_value,
        s_ecc_derive_suite_secret_access_key_test_value,
        NULL,
        UINT64_MAX);
    ...
    pub_coord_x.len -= 1;
    ASSERT_BIN_ARRAYS_EQUALS(
        s_expected_suite_pub_x->bytes, s_expected_suite_pub_x->len, pub_coord_x.buffer, pub_coord_x.len);
    ...
    pub_coord_y.len -= 1;
    ASSERT_BIN_ARRAYS_EQUALS(
        s_expected_suite_pub_y->bytes, s_expected_suite_pub_y->len, pub_coord_y.buffer, pub_coord_y.len);
...
AWS_TEST_CASE(credentials_derive_ecc_key_suite, s_credentials_derive_ecc_key_suite);
