...
enum aws_auth_errors {
    AWS_AUTH_PROFILE_PARSE_RECOVERABLE_ERROR = AWS_C_AUTH_PACKAGE_ID * AWS_ERROR_ENUM_STRIDE,
    ...
    AWS_AUTH_ERROR_END_RANGE = (AWS_C_AUTH_PACKAGE_ID + 1) * AWS_ERROR_ENUM_STRIDE - 1
};

enum aws_auth_log_subject {
    AWS_LS_AUTH_GENERAL = AWS_C_AUTH_PACKAGE_ID * AWS_LOG_SUBJECT_STRIDE,
    AWS_LS_AUTH_PROFILE,
    AWS_LS_AUTH_CREDENTIALS_PROVIDER,
    AWS_LS_AUTH_SIGNING,

    AWS_LS_AUTH_LAST = (AWS_C_AUTH_PACKAGE_ID + 1) * AWS_LOG_SUBJECT_STRIDE - 1
};
