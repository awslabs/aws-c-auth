...
typedef void(on_aws_get_credentials_callback_fn)(
    struct aws_credentials *credentials, void *user_data);

typedef int(get_credentials_async_fn)(
    struct aws_credentials_provider *provider,
    on_aws_get_credentials_callback_fn callback, void *user_data);
typedef void(aws_credentials_provider_cleanup_fn)(
    struct aws_credentials_provider *provider);
 ...
 */
AWS_AUTH_API
void aws_credentials_provider_destroy(
    struct aws_credentials_provider *provider);
...
AWS_AUTH_API
struct aws_credentials_provider *
aws_credentials_provider_static_new(struct aws_allocator *allocator,
                                    const struct aws_string *access_key_id,
                                    const struct aws_string *secret_access_key,
                                    const struct aws_string *session_token);
...
AWS_AUTH_API
struct aws_credentials_provider *
aws_credentials_provider_environment_new(struct aws_allocator *allocator);
...
AWS_AUTH_API
struct aws_credentials_provider *
aws_credentials_provider_chain_default_new(struct aws_allocator *allocator);
