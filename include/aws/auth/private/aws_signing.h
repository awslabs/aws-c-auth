...
AWS_AUTH_API extern const struct aws_string *g_aws_signing_amz_date_name;
AWS_AUTH_API extern const struct aws_string *g_aws_signing_vanilla_date_header_name;
